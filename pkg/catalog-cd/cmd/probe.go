...
import (
	...
	"github.com/otaviof/catalog-cd/pkg/catalog-cd/assert"
	"github.com/otaviof/catalog-cd/pkg/catalog-cd/config"
	"github.com/otaviof/catalog-cd/pkg/catalog-cd/flags"
	"github.com/otaviof/catalog-cd/pkg/catalog-cd/probe"
